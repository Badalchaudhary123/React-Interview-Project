    ...
    return (
        ...
        <table>
                ...
                <td>
                    ...
                    <input type="text" value={sum} placeholder="Enter Total" disabled/>
                </td>
                <td>
                  

                    <button  type="submit" onClick={Calculation}>Add</button>
                </td>
                </tr>
        </table>
        <h3>  Products  </h3>
        ...
        <div>
                ...
                <input type="text"  placeholder="Enter Total" required  disabled
                value={total} />
                <br/>
                <button type="button"  onClick={ refreshPage }> <span>Clear all</span> </button> 
